...
RANDOM_PROMPTS=(
  ...
  "你好呀" "哈喽" "嘿" "来了" "上班了"
  "howdy" "greetings" "what's up" "cheers" "hiya"
  "开始吧" "准备好了" "新的一天" "继续" "出发"
  "let's go" "ready" "new day" "go" "start"
  "报到" "打卡" "签到" "就位" "到了"
  "here" "present" "check in" "reporting" "online"
  "冲" "干活" "走起" "搞起" "动手"
  "begin" "working" "on it" "rolling" "moving"
  "起床了" "清醒了" "精神了" "状态好" "满血"
  "awake" "fresh" "energized" "charged" "alive"
  "又是一天" "日常" "例行" "如常" "照旧"
  "another day" "routine" "as usual" "same old" "daily"
  "加油" "奥利给" "冲冲冲" "稳" "行"
  "go go go" "nice" "cool" "ok" "right"
  "就绪" "待命" "候着" "恭候" "伺候"
  "standby" "awaiting" "at your service" "roger" "copy"
)
